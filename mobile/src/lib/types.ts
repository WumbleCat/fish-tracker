/** Shapes the API returns — mirrors backend Pydantic schemas, never extended
 * with client-invented fields. Deliberately duplicated from web/ (see repo
 * skill: no shared package until there's a third consumer). */

...
SKILL_TEMPLATE = """---
name: {skill_name}
description: "[TODO: Briefly describe what this skill does and when it applies, using phrases a user would say.]"
---
...
def init_skill(skill_name, path, resources, include_examples):
    ...
    print("3. Add optional frontmatter only if the skill needs it (see references/frontmatter.md)")

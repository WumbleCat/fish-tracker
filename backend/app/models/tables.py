...
class GameMember(Base):
    ...
    # The host who seated them; NULL means they joined themselves and hold a
    # credential. Only such a member can be handed the game.
    seated_by: Mapped[uuid.UUID | None] = mapped_column(
